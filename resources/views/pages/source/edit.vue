    ...
    <LayoutDashboard>
        <div class="w-full bg-white shadow-sm rounded">
            <div class="mx-auto flex w-full items-center justify-between px-3 mt-3">
                ...
                <Link v-tooltip="'Go back'" :href="route('ltu.source_translation')"
        ...
        <div class="mx-auto py-4">
            <div class="flex w-full flex-col gap-8 lg:flex-row">
                <div
                    class="relative w-full overflow-hidden rounded-md bg-white shadow ring-2 ring-blue-100 focus-within:ring-blue-400">
                    ...
                    <div class="flex h-[calc(100%-80px)]">
                        <input-textarea id="textArea" v-model="form.phrase" rows="7" autofocus
                ...
                <div class="w-full overflow-hidden rounded-md bg-white shadow ring-2 ring-blue-100">
                    <div class="flex min-h-[231px] flex-col p-4">
                        <div class="w-full space-y-1">
                            ...
                            <InputNativeSelect id="file" v-model="form.file" size="md" :error="form.errors.file"
                        ...
                        <div class="mt-4 w-full space-y-1">
                            ...
                            <InputTextarea id="note" v-model="form.note" size="md" rows="3" class="resize-none"
                                :error="form.errors.note" placeholder="Add a note to this translation" />
                    ...
                    <div class="grid grid-cols-2 border-t border-blue-200">
                        ...
                        <BaseButton :is-loading="form.processing" variant="primary"
                            class="flex items-center justify-center rounded-none py-4 !text-sm !font-medium uppercase"
                            @click="submit">
