...
<template>
    ...
    <LayoutDashboard>
            ...
            <div class="mx-auto flex w-full items-center justify-between px-3 mt-3">
                <div class="flex w-full items-center">
                    <div class="flex w-full items-center gap-3 py-4">
                        <Link :href="route('ltu.phrases.index', translation.id)"
                        ...
                        <div
                            class="flex items-center gap-2 rounded-md border border-blue-100 bg-blue-50 px-2 py-1 text-blue-500">
                ...
                <Link v-tooltip="'Go back'" :href="route('ltu.phrases.index', translation.id)"
        ...
        <div class="mx-auto py-4">
            <div class="flex w-full flex-col lg:flex-row">
                <div class="relative w-full overflow-hidden rounded-md bg-white shadow ring-2 ring-blue-100">
                    <div class="flex items-center justify-between border-b">
                        <div class="flex gap-2 px-4 py-2.5">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="rounded-md border px-1.5 py-0.5 text-xs text-gray-500"
                                    v-text="source.language.code"></div>
                            </div>
                        </div>

                        <div class="flex items-center divide-x border-l">
                            <button v-tooltip="'Copy'" type="button" class="group h-full p-3 hover:bg-blue-50"
                                @click="useTranslation(phrase.source.value)">
                                <IconClipboard class="size-5 text-gray-400 group-hover:text-blue-600" />
                            </button>

                            <Link v-tooltip="'Edit Source Key'"
                                :href="route('ltu.source_translation.edit', phrase.source.uuid)" type="button"
                                class="group h-full p-3 hover:bg-blue-50" v-if="phrase.source">
                    ...
                    <div class="flex w-full items-center justify-center gap-4 border-t border-blue-200 px-4 py-1.5">
                        ...
                        <button v-tooltip="langCode ? 'Speak' : 'Language not supported'"
                            ...
                            :disabled="!langCode && !speech.isPlaying.value" @click="langCode && speech.speak()">
                ...
                <div
                    class="w-full overflow-hidden rounded-md bg-white shadow ring-2 ring-blue-100 focus-within:ring-blue-400">
                    <div class="flex items-center justify-between border-b px-4">
                        <div class="flex gap-2 py-2.5">
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="text-sm font-semibold text-gray-800" v-text="translation.language.name">
                                </div>
                    ...
                    <div class="flex">
                        <input-textarea id="textArea" v-model="form.phrase" dir="auto" rows="7" autofocus
                            class="size-full resize-none rounded-none border-none px-4 py-2.5 shadow-none ring-transparent focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0" />
                    </div>

                    <div class="grid grid-cols-2 border-t border-blue-200">
                        <Link :href="route('ltu.phrases.index', translation.id)"
                            class="flex items-center justify-center bg-blue-50 py-4 text-sm font-medium uppercase text-blue-600 hover:bg-blue-100">
                        Cancel </Link>

                        <BaseButton :is-loading="form.processing" variant="primary"
                            class="flex items-center justify-center rounded-none !py-4 !text-sm !font-medium uppercase text-center"
                            @click="submit">
            ...
            <tabs>
                <tab name="Suggestions" class="w-full"
                    ...
                    <MachineTranslate :suggested-translations="suggestedTranslations"
                        :language="translation.language.code" @use-translation="useTranslation" />
                </tab>

                <tab prefix='<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 3.33334C8.81665 3.33334 5.83331 6.31668 5.83331 10C5.83331 13.6833 8.81665 16.6667 12.5 16.6667C16.1833 16.6667 19.1666 13.6833 19.1666 10C19.1666 6.31668 16.1833 3.33334 12.5 3.33334ZM12.5 15C9.74165 15 7.49998 12.7583 7.49998 10C7.49998 7.24168 9.74165 5.00001 12.5 5.00001C15.2583 5.00001 17.5 7.24168 17.5 10C17.5 12.7583 15.2583 15 12.5 15ZM5.83331 5.29168C3.89165 5.97501 2.49998 7.82501 2.49998 10C2.49998 12.175 3.89165 14.025 5.83331 14.7083V16.45C2.95831 15.7083 0.833313 13.1083 0.833313 10C0.833313 6.89168 2.95831 4.29168 5.83331 3.55001V5.29168Z"></path></svg>'
                    name="Similar">
